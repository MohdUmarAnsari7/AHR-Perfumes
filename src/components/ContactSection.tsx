    ...
    <section className="py-12 bg-[#FAF9F6] border-t border-gray-200">
      <div className="max-w-[1440px] 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <div className="text-center mb-8">
           <h2 className="font-serif text-3xl md:text-5xl text-gray-900 mb-4">{details.title}</h2>
           <div className="w-24 h-1 bg-gold-primary mx-auto mb-6"></div>
           <p className="text-gray-600 max-w-2xl mx-auto">{details.subtitle}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-12">
            <div>
              <h3 className="font-serif text-2xl text-gold-accent mb-6">Visit Our Store</h3>
              <ul className="space-y-6 text-gray-700">
                <li className="flex items-start group">
                  <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center mr-4 group-hover:border-gold-primary transition-colors flex-shrink-0">
                    <MapPin className="w-5 h-5 text-gold-primary" />
                  </div>
                  <div className="pt-3">
                    <p className="font-medium text-gray-900 mb-1">Address</p>
                    <p className="text-sm leading-relaxed">{details.address}</p>
                  </div>
                </li>
                <li className="flex items-start group">
                  <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center mr-4 group-hover:border-gold-primary transition-colors flex-shrink-0">
                  ...
                  <div className="pt-3">
                    ...
                    <p className="text-sm leading-relaxed">Mon - Sat: {details.hoursWeekdays}<br/>Sun: {details.hoursSunday}</p>
                  </div>
                </li>
                <li className="flex items-start group">
                  <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center mr-4 group-hover:border-gold-primary transition-colors flex-shrink-0">
                  ...
                  <div className="pt-3">
                    ...
                    <p className="text-sm leading-relaxed">{details.phone}</p>
                  </div>
                </li>
                <li className="flex items-start group">
                  <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center mr-4 group-hover:border-gold-primary transition-colors flex-shrink-0">
                  ...
                  <div className="pt-3">
                    ...
                    <p className="text-sm leading-relaxed">{details.email}</p>
                  </div>
                </li>
                <li className="flex items-start group">
                  <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center mr-4 group-hover:border-gold-primary transition-colors flex-shrink-0">
                  ...
                  <div className="pt-3">
                    ...
                    <p className="text-sm leading-relaxed">{details.instagram}</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-white p-8 md:p-10 border border-gray-200">
            <h3 className="font-serif text-2xl text-gray-900 mb-2">{formSection.title}</h3>
            <p className="text-xs text-neutral-500 mb-8">{formSection.subtitle}</p>
